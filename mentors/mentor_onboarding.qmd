---
title: "Cohort Mentor Onboarding"
---

# Welcome Water Boards Champions Cohort Mentors!

As you begin your Openscapes Cohort Mentor journey with the Water Boards - we want to be sure you have the resources you need to help you get started. Below is a non-comprehensive, but hopefully informative guide to onboarding as a mentor at the Water Boards. Please re-reference and contribute to revising this page throughout your time as a Water Boards Openscapes Champions Cohort Mentor!

::: callout-note
## Note for Community Mentors

This page is dedicated to Champions Cohort Mentor Onboarding. Since Community Mentors have already participated in an Openscapes Cohort or as a Cohort Mentor, you should already be familiar with much of the information below. Additional Community Mentor onboarding will be provided as needed or requested.
:::
...
-   **Google Drive (Internal & Select External Partner Access):** used for Instruction Team planning and preparing cohort communications, draft agendas and slides. Mentors won't need to access these files directly, but may view them via screen sharing and co-working with instructors.

-   **OneDrive (Internal Only Access):** used for sharing/storing final meeting materials with individuals within each cohort. Once agendas and slides are finalized in Google, Openscapes Instructors will save copies over to the OneDrive. Mentors will gain access to two folders:

    -   **Mentor Materials Folder** - will only be shared with mentors and will contain all of the planning documents we need to prepare for the cohort, including our shared Mentor Seaside Chat Document.

    -   **Meeting Materials Folder** - will be shared with the entire cohort and will contain final agendas, slides, and meeting recordings.
...
-   **Shared Seaside Chats Doc**: we will use a MS Word doc to keep track of our Seaside Chat agendas and notes. We will add to this document during meetings and possibly also asynchronously in between meetings.
...
-   **Outlook Calendar**: used to schedule all meetings
    ...
    -   Optional meetings: Co-working, 2-month Check-in
...
-   Overview of how we use GitHub for communication and coordination with Issues and Projects
...
-   Practice navigating between OneDrive folders and GitHub
